...
var PayStripePage = /** @class */ (function () {
    function PayStripePage(router, activatedRoute, alertController, firebase, toastController, formBuilder, DataService, stripe) {
        this.router = router;
    ...
    PayStripePage.prototype.add = function (value) {
        var _this = this;
        this.isLoading = true;
        var card = {
            number: value.number,
        ...
        this.stripe.createCardToken(card)
            .then(function (token) { return _this.save(token.id); })
            .catch(function (error) { return console.error(error); });
    };
    PayStripePage.prototype.save = function (token) {
        var _this = this;
        this.isLoading = true;
