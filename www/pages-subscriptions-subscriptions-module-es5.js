...
var SubscriptionsPageRoutingModule = /** @class */ (function () {
    function SubscriptionsPageRoutingModule() {
    }
...
var SubscriptionsPage = /** @class */ (function () {
    function SubscriptionsPage(firebase, stripe, loadingController, router, modalCtrl, toastController, location, DataService) {
    ...
    SubscriptionsPage.prototype.ionViewDidEnter = function () {
    ...
    SubscriptionsPage.prototype.getsubscriptions = function () {
        var _this = this;
        this.presentLoading();
        this.DataService.getusersubscriptions(this.email)
            .subscribe(function (resp) {
            _this.stopLoading();
            _this.subscriptions = resp;
        });
    };
    SubscriptionsPage.prototype.presentLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    SubscriptionsPage.prototype.stopLoading = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var self;
...
//# sourceMappingURL=pages-subscriptions-subscriptions-module-es5.js.map